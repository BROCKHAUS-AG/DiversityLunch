...
import { IdentifiableOptionsList } from './identifiable-options-list';
...
describe('OptionsList', () => {
    ...
    it('should add new input elements for added element when the add button was clicked', async () => {
        ...
        expect(addedDescriptorTextField!.parentElement!.tagName).toEqual('ARTICLE'); // see edit-form-field.tsx
