WITH algeria AS (SELECT id FROM  country_entity WHERE country_entity.descriptor='Algerien' LIMIT 1),
    ...
    academicFamily AS (SELECT id FROM sexual_orientation_entity WHERE sexual_orientation_entity.descriptor='Akademikerfamilie' LIMIT 1),
...
INSERT INTO profile_entity(id, birth_year, email, name, diet_id, education_id, gender_id, hobby_id,mother_tongue_id, origin_country_id, project_id, religion_id, work_experience_id, sexual_orientation_id, social_background_discrimination_id ) VALUES
    (1, 1998, 'first.profile@some.tdl', 'first', (SELECT * FROM meat), (SELECT * FROM study), (SELECT * FROM male), (SELECT * FROM cooking), (SELECT * FROM german), (SELECT * FROM algeria), (SELECT * FROM internProject), (SELECT * FROM jewish),(SELECT * FROM lowExperience),(SELECT * FROM heterosexual), (SELECT * FROM yes) ),
    (2, 1999, 'second.profile@some.tdl', 'second', (SELECT * FROM vegan), (SELECT * FROM study), (SELECT * FROM male), (SELECT * FROM cooking), (SELECT * FROM german), (SELECT * FROM algeria), (SELECT * FROM internProject), (SELECT * FROM jewish),(SELECT * FROM lowExperience),(SELECT * FROM heterosexual), (SELECT * FROM yes) ),
    (3, 1990, 'third.profile@some.tdl', 'third', (SELECT * FROM vegan), (SELECT * FROM training), (SELECT * FROM female), (SELECT * FROM cooking), (SELECT * FROM german), (SELECT * FROM algeria), (SELECT * FROM internProject), (SELECT * FROM jewish),(SELECT * FROM lowExperience),(SELECT * FROM heterosexual), (SELECT * FROM yes) ),
    (4, 1974, 'fourth.profile@some.tdl', 'fourth', (SELECT * FROM vegan), (SELECT * FROM training), (SELECT * FROM female), (SELECT * FROM gaming), (SELECT * FROM english), (SELECT * FROM andorra), (SELECT * FROM externProject), (SELECT * FROM christian),(SELECT * FROM lowExperience),(SELECT * FROM heterosexual), (SELECT * FROM yes) ),
    (5, 1998, 'copyOfFirst.profile@some.tdl', 'copyOfFirst', (SELECT * FROM meat), (SELECT * FROM study), (SELECT * FROM male), (SELECT * FROM cooking), (SELECT * FROM german), (SELECT * FROM algeria), (SELECT * FROM internProject), (SELECT * FROM jewish),(SELECT * FROM lowExperience),(SELECT * FROM heterosexual), (SELECT * FROM yes) );
