...
class ProfileControllerIT {
    ...
    void testGetProfile_withValidId_thenOKWithExpectedProfile() throws Exception {
        this.mockMvc
                ...
                .andExpect(jsonPath("$.hobby.descriptor").value(myProfileEntity.getHobby().get(0).getDescriptor()))
                .andExpect(jsonPath("$.hobby.category.descriptor").value(myProfileEntity.getHobby().get(0).getCategory().getDescriptor()))
